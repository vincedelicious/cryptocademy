...
card1 = Card.create!(header: "Web3?", content: "Web3 Content", card_number: "1", lesson: lesson1)
card2 = Card.create!(header: "Blockchain", content: "Blockchain Content", card_number: "2", lesson: lesson1)
card3 = Card.create!(header: "Token", content: "Token Content", card_number: "3", lesson: lesson1)
card4 = Card.create!(header: "Wallet", content: "Wallet Content", card_number: "4", lesson: lesson1)
card5 = Card.create!(header: "Quiz", content: "Quiz Content", card_number: "5", lesson: lesson1)
