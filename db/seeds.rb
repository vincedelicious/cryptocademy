...
card1 = Card.create!(header: "A Quick Tutorial", content: "Welcome to Cryptocademy!
  Our lessons take the form of cards with keywords, definitions & examples, followed by a quiz.
  The idea of each lesson is to introduce you to the main concept & then dive into the topic.
...
card2 = Card.create!(header: "Blockchain", content: "Imagine a ledger or logbook that keeps a record of transactions.
  Now imagine if that ledger was on the internet and being looked at by billions of people & computers.
  Everyone looking at this ledger has a copy of it, and every time there is a new transaction,
  everyone checks to that everyone else got that same transaction and no one is writing down fake stuff.",
  card_number: "2", lesson: lesson1)
card3 = Card.create!(header: "Blockchain", content: "That is essentially a blockchain!
  It’s a shared & distributed record (chain) of transactions (blocks) that are being monitored & agreed upon by so many
  computers that it is essentially impossible to hack or defraud.
...
card4 = Card.create!(header: "Different 'versions' of the Web", content: "
  Web1 was roughly the first version of the internet where you could access pages that displayed information.
  Think... an encyclopaedia or a novel.
  Web1: Read 📖",
  card_number: "4", lesson: lesson1)
card5 = Card.create!(header: "Web2 - User Content", content: "
  Web2 was when users could upload info like videos, blogs & posts to sites.
  YouTube, Facebook, Instagram, Twitter. This is where most of the web today is.
  Web2: Read-Write 📖 🖊️",
  card_number: "5", lesson: lesson1)
card6 = Card.create!(header: "Web3 - User Ownership", content: "
  The next step is verifiable ownership of digital assets. Where users can definitively claim that something digital is theirs.
  Web3 is what we think this is, and the next step of the internet is.
  It can exist on blockchains, is distributed & decentralised in nature.
  These ‘versions’ don’t have updates to run or destroy old versions of sites, it’s just a kind of lens to view the internet
  and what sort of things its users are getting up to.
...
card7 = Card.create!(header: "Tokens", content: "
  ...
  Common Tokens you may have heard of could be Bitcoin, Ether or DogeCoin.",
...
card8 = Card.create!(header: "Wallets", content: "
  ...
  Anyone who has the private key can access all the contents of your wallet.
  Exactly like if their hand could reach right into your physical wallet and take your stuff!",
  card_number: "8", lesson: lesson1)
card9 = Card.create!(header: "That's the basics!", content: "
  Well done! You've taken the first step into this new world.
  The words you've just read about will be explained in further detail in the rest of the course, but you're truly in it now.
  Goodluck with the quiz, and welcome to Web3!",
